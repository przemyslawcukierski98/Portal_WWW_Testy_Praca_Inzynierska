...
namespace OnlineTesty_PracaInzynierska.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "Hasło musi zawierać od 6 do 100 znaków", MinimumLength = 6)]
            [DataType(DataType.Password)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Hasło zostało zmienione poprawnie";
